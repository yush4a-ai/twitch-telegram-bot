...
ABOUT_TEXT = (
    "ℹ️ <b>Что я умею</b>\n\n"
    "🔔 <b>Уведомление о начале стрима</b> — как только отслеживаемый канал выходит "
    "в эфир, присылаю сообщение с именем канала и названием стрима, и обновляю счётчик "
    "зрителей прямо в нём, пока идёт эфир.\n\n"
    ...
    "🚩 <b>Детектор накрутки</b> — если на графике зрителей резкий скачок тут же "
    "сменяется таким же резким спадом (похоже на накрутку ботами, а не органический "
    "рост), такая точка помечается в отчёте и не портит честные пик и среднее число "
    "зрителей.\n\n"
    ...
    "(уведомление о начале стрима всегда остаётся в группе, где отслеживается канал).\n\n"
    ...
    "📌 <b>Для стримеров и админов групп</b> — подключи свой канал в группе, и уведомление "
    "о старте стрима будет публиковаться туда полностью автоматически, без твоего участия. "
    "Когда стрим закончится, сообщение само удалится — группа не захламляется старыми "
    "постами.\n\n"
