...
ведёт VOD-архив и топ чатеров. В обычной группе итог отправляется только в
привязанную личку. В Telegram-канале публичный итог включается отдельно для
каждого Twitch-канала и по умолчанию выключен.

В live-постах Telegram-каналов подписчик может нажать «Подключить уведомления»
и сразу добавить этого Twitch-стримера в свои личные отслеживания.
